...
public class JzzSoundManager : MonoBehaviour
{
	...
	*/
	...
	void Awake ()
	{
		...
		for (int i = 0; i < sources.Length; i++) {
			sources [i] = (AudioSource)instance.AddComponent (typeof(AudioSource));
		}
	...
	// Get Singleton
	public static JzzSoundManager GetSingleton ()
	{
		if (instance == null) {
			instance = new GameObject ();
			return (JzzSoundManager)instance.AddComponent (typeof(JzzSoundManager));
		}
		return (JzzSoundManager)instance.GetComponent (typeof(JzzSoundManager));
	}
